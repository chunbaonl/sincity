...
public class Server {
    ...
    public static boolean JSON_IS_ZIPPED=false;
    ...
    public static String JERSEY_OAUTH_TOKEN="4BFDEA90-E557-4C84-9003-F8E203BB6F3D";
    public static String SERVER_403_MESSAGE="Your App is too old.";
}
